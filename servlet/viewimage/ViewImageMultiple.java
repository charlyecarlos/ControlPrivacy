...
/**
 * Servlet implementation class ViewImageMultiple
 */

public class ViewImageMultiple extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{	
			...
			String [] folders = datos.getFieldFileValues("imageFile");
			if(folders == null)
...
//			System.out.println(namefile[namefile.length-1]);
			...
			for (String folder : folders) {
				...
				Image image=new Image(url_redirect,relativePath , user, Fecha.fechaActual(), Fecha.sumarMesesFecha(Fecha.fechaActual(), timeExpired));
