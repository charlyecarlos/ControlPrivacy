...
INSERT INTO USERS (ID_USER,EMAIL,NAME,PWD,TYPE,ACCESS_FAIL,DATE_CREATION,DATE_LAST_ACCESS,LOCKED,ACTIVE) 
	VALUES ('0','anonymous','anonymous','','1',0,'0000-00-00','0000-00-00','Y','N'
);
...
CREATE TABLE FILE_ANALYSES(
	...
	SENSITIVE_METADATA_DELETE DECIMAL(20) NOT NULL DEFAULT 0,
	DATE_ANALYSE TIMESTAMP NOT NULL
);

CREATE TABLE STATISTICS_FILE(
	ID_FILE VARCHAR(20) PRIMARY KEY,
...
CREATE TABLE LOGOS(
 ...
 CONSTRAINT PK_LOGO PRIMARY KEY (USER,URL_IMAGE),
 CONSTRAINT FK_LOGOS_USERS FOREIGN KEY (USER) REFERENCES USERS(ID_USER)
);
...
CREATE TABLE ACTIVATION(
 ...
 USER VARCHAR(50) NOT NULL,
 CONSTRAINT FK_ACTIVATION_USERS FOREIGN KEY (USER) REFERENCES USERS(ID_USER)
);