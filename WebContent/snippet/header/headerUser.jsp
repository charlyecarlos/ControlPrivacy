...
<% User userHeader=(User) session.getAttribute("user");%>
  <!-- Navigation-->
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top no-padding" id="mainNav">
    <a class="navbar-brand" href="user.html"><img class="logo-header" src="./img/logo.png"></a>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="login.html?session=off">Logout</a>
          </div>
        </div>
      </div>
    </div>
